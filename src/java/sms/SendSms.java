...
public class SendSms {
    ...
    public SendSms(String oid, String amount){
        this.oid = oid;
        this.amount = amount;
    }
  	//here jdbc code write in which rest details fetched
  
	 public void sendsms()//rest hold all information of
	 {   int n=0;
		...
		System.out.println("number me resta ka number likhana");
                String message="details of items"
                       + amount+oid+"user address"+"user number"+"user name"+"Accept order click here "+"http://localhost:8080/webprac/paytm_page/sms2.jsp?n=12334";//dekh lena 
                String number="6264940767";                                  // upr ki link dekhna hai abhi
